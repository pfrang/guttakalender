...
export default function PlanIdDetailsModal() {
  ...
  const plan = useQuery(
    ...
    planId ? { planId: planId as Id<"plans"> } : "skip",
  );

  useEffect(() => {
    navigation.setOptions({
      headerTitle: plan?.location,
    });
  }, [navigation, plan?.location]);
  ...
  if (plan === undefined || allUsers === undefined || user === undefined) {
    return (
      <View style={styles.centered}>
